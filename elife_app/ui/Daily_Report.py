...
def create_daily_report_page(
    entry_dao: EntryDAO, wellness_service: WellnessService
) -> None:
    ...
    def daily_report_page() -> None:
        ...
        with ui.column().classes(
            "w-full items-center gap-4 p-8 text-slate-900 min-h-screen"
        ):
            ...
            def refresh() -> None:
                ...
                if entry is None:
                    date_label.set_text("No entries yet. Add a daily entry first.")
